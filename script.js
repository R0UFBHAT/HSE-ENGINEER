...
(function(){
  ...
  const updateTransform = (x, y) => {
    photo.style.transform = `scale(1.08) rotateX(${y}deg) rotateY(${x}deg)`;
  };
  ...
  frame.addEventListener('mousemove', e => {
    ...
    updateTransform(px * 12, py * -10);
  });

  frame.addEventListener('mouseleave', () => {
    photo.style.transform = 'scale(1) rotateX(0deg) rotateY(0deg)';
  });
